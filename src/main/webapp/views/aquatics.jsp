			...
			<div class="container">
				...
				<nav class="navbar navbar-expand-lg navbar-light bg-light">
					...
					<div class="navbar-nav">
						...
						<a class="nav-item nav-link active"href="aquatics">Vizi állatok</a>
				...
				<h2 style="text-align:center; margin: 20px 0 20px 0">Vizi állatok</h2>
				
				<table class="table table-striped table-bordered">
				
				<tbody>
					<tr>
						<td><a href="fishes">Halaink</a></td>
					</tr>				
				</tbody>
			</table>
</div>
