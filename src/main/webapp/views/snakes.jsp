	...
	<c:choose>
		...
		<c:otherwise>
			...
			<div class="container">
				...
				<h2 style="text-align:center; margin: 20px 0 20px 0">Kígyóink</h2>
				...
				<c:if test="${privileg eq 'administrator'}">
					...
					<div id="saveEntity">
						...
						<form action="snakes" method="post">
							...
							<table style="text-align:center" class="table">
								...
								<tbody>
									...
									<tr>
										...
										<th>
											<select class="form-select" name="isVenomous">
				...
				<c:choose>
					...
					<c:when test="${listEntity.size() > 0}">
						...
						<div id="entityTable">
							...
							<form id="editForm"  action="snakes" method="post">
										...
										<c:choose>
											...
											<c:when test="${privileg eq 'administrator' && editId == entity.id}">
												...
												<tr>
													...
													<td>
														<select class="form-select" name="isVenomous" >
															<option value="${entity.isVenomous}" selected hidden>${entity.isVenomous}</option>
															<option value="false">Nem</option>
															<option value="true">Igen</option>
														</select>												
													</td>
					...
					<c:otherwise>
						<h3 style="text-align:center; color:red">Jelenleg egyik üzletünkben sincs kígyó!</h3>
					</c:otherwise>
