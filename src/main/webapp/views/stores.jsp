			...
			<div class="container">
				...
				<nav class="navbar navbar-expand-lg navbar-light bg-light">
					...
					<div class="navbar-nav">
						...
						<a class="nav-item nav-link active" href="stores">Üzleteink</a>
				...
				<h2 style="text-align:center; margin: 20px 0 20px 0">Üzleteink</h2>
						...
						<form action="stores" method="post">
							...
							<table style="text-align:center" class="table">
								...
								<thead>
									...
									<tr>
										<th>Név<span style="color:red">*</span></th>
										<th>Cím<span style="color:red">*</span></th>
									</tr>
				...
				<c:choose>
					...
					<c:when test="${listEntity.size() > 0}">
						...
						<div id="entityTable">
							...
							<form id="editForm"  action="stores" method="post">
