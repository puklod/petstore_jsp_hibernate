	...
	<c:choose>
		...
		<c:otherwise>
			...
			<div class="container">
				...
				<h2 style="text-align:center; margin: 20px 0 20px 0">Halaink</h2>
							...
							<table style="text-align:center" class="table">
								...
								<thead>
									...
									<tr>
										...
										<th>Szín</th>
										<th>Testméret</th>
										<th>Szükséges akvárium mérete</th>
										<th>Üzlet</th>
									</tr>
								...
								<tbody>
									...
									<tr>
										...
										<th>
											<select class="form-select" name="tankSizeRequirment">
												<option value="Kicsi">Kicsi</option>
												<option value="Közepes">Közepes</option>
												<option value="Nagy">Nagy</option>
											</select>
				...
				<c:choose>
					...
					<c:when test="${listEntity.size() > 0}">
						...
						<div id="entityTable">
							...
							<form id="editForm"  action="fishes" method="post">
										...
										<c:choose>
											...
											<c:when test="${privileg eq 'administrator' && editId == entity.id}">
												...
												<tr>
													...
													<td>
														<select class="form-select" name="tankSizeRequirment">
															<option value="${entity.tankSizeRequirment}" selected hidden>${entity.tankSizeRequirment}</option>
															<option value="Kicsi">Kicsi</option>
															<option value="Közepes">Közepes</option>
															<option value="Nagy">Nagy</option>
														</select>												
											...
											<c:otherwise>
												...
												<tr>
													...
													<td>${entity.color}</td>
													<td>${entity.size}</td>
													<td>${entity.tankSizeRequirment}</td>
					...
					<c:otherwise>
						<h3 style="text-align:center; color:red">Jelenleg egyik üzletünkben sincs hal!</h3>
					</c:otherwise>
