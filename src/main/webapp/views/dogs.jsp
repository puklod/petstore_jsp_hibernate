	...
	<c:choose>
		...
		<c:otherwise>
			...
			<div class="container">
				...
				<h2 style="text-align:center; margin: 20px 0 20px 0">Kutyáink</h2>
						...
						<form action="dogs" method="post">
							...
							<table style="text-align:center" class="table">
								...
								<thead>
									...
									<tr>
										<th>Kor (min. 0,5)<span style="color:red">*</span></th>
								...
								<tbody>
									...
									<tr>
										...
										<th>
											<select class="form-select" name="furLength">
				...
				<c:choose>
					...
					<c:when test="${listEntity.size() > 0}">
						...
						<div id="entityTable">
							...
							<form id="editForm"  action="dogs" method="post">
										...
										<c:choose>
											...
											<c:when test="${privileg eq 'administrator' && editId == entity.id}">
												...
												<tr>
													...
													<td>
														<input type="number" step="any" class="form-control" name="age" value="${entity.age}">
													</td>
													...
													<td>
														<input type="text" class="form-control" name="furColor" value="${entity.furColor}"/>
													</td>
													
													<td>
														<select class="form-select" name="furLength" >
															<option value="${entity.furLength}" selected hidden>${entity.furLength}</option>
															<option value="Rövid">Rövid</option>
															<option value="Közepes">Közepes</option>
															<option value="Hosszú">Hosszú</option>
															<option value="Egyéb">Egyéb</option>
											...
											<c:otherwise>
												...
												<tr>
													...
													<td>${entity.age}</td>
													<td>${entity.type}</td>
													<td>${entity.furColor}</td>
													<td>${entity.furLength}</td>
													<td>${entity.size}</td>
					...
					<c:otherwise>
						<h3 style="text-align:center; color:red">Jelenleg egyik üzletünkben sincs kutya!</h3>
					</c:otherwise>
